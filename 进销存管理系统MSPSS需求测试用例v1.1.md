...
<a href="#1">    用例1 商品分类</a><br>
<a href="#2">      1.1测试用例套件</a><br>
<a href="#3">      1.2测试套件覆盖情况</a><br>
<a href="#4">    用例2 商品管理</a><br>
<a href="#5">      2.1测试用例套件</a><br>
<a href="#6">      2.2 测试套件覆盖情况</a><br>
<a href="#7">    用例3 库存查看</a><br>
<a href="#8">      3.1测试用例套件</a><br>
<a href="#9">      3.2 测试用例套件覆盖情况</a><br>
<a href="#10">    用例4 库存盘点</a><br>
<a href="#11">      4.1测试用例套件</a><br>
<a href="#12">      4.2 测试用例套件覆盖情况</a><br>
<a href="#13">    用例5 处理库存单据</a><br>
<a href="#14">      5.1测试用例套件</a><br>
<a href="#15">      5.2 测试用例套件对需求的覆盖情况</a><br>
<a href="#16">    用例 6 客户管理</a><br>
<a href="#17">      6.1 测试用例套件</a><br>
<a href="#18">      6.2测试用例套件覆盖情况</a><br>
<a href="#19">    用例7 制定进货单</a><br>
<a href="#20">      7.1 测试用例套件</a><br>
<a href="#21">      7.2测试用例套件覆盖情况</a><br>
<a href="#22">    用例7 制定进货退货单</a><br>
<a href="#23">      7.1 测试用例套件</a><br>
<a href="#24">      7.2测试用例套件覆盖情况</a><br>
<a href="#25">    用例8 制定销售单</a><br>
<a href="#26">      8.1 测试用例套件</a><br>
<a href="#27">      8.2 测试用例套件覆盖情况</a><br>
<a href="#28">    用例7 制定销售退货单</a><br>
<a href="#29">      7.1 测试用例套件</a><br>
<a href="#30">      7.2测试用例套件覆盖情况</a><br>
<a href="#31">    用例9 账户管理</a><br>
<a href="#32">      9.1测试用例套件</a><br>
<a href="#33">      9.2测试用例套件覆盖情况</a><br>
<a href="#34">    用例10制定收款单及现金费用单</a><br>
<a href="#35">      10.1 测试用例套件</a><br>
<a href="#36">      10.2测试用例套件覆盖情况</a><br>
<a href="#37">    用例11 制定付款单</a><br>
<a href="#38">      11.1 测试用例套件</a><br>
<a href="#39">      11.2测试套件覆盖情况</a><br>
<a href="#40">    用例12 查看导出报表</a><br>
<a href="#41">      12.1 测试用例套件</a><br>
<a href="#42">       12.2 测试用例套件覆盖情况</a><br>
<a href="#43">    13 期初建账</a><br>
<a href="#44">      13.1 测试用例套件</a><br>
<a href="#45">      13.2 测试用例套件覆盖情况</a><br>
<a href="#46">    用例14 查看导出销售明细表测试用例</a><br>
<a href="#47">       14.1 测试用例套件</a><br>
<a href="#48">       14.2 测试用例套件覆盖情况</a><br>
<a href="#49">     用例15 查看导出经营情况表测试用例</a><br>
<a href="#50">       15.1 测试用例套件</a><br>
<a href="#51">      15.2 测试用例套件覆盖情况</a><br>
<a href="#52">     用例16 审批单据测试用例</a><br>
<a href="#53">       16.1 测试用例套件</a><br>
<a href="#54">       16.2 测试用例套件覆盖情况</a><br>
<a href="#55">     用例17 查询日志测试用例</a><br>
<a href="#56">       17.1 测试用例套件</a><br>
<a href="#57">       17.2 测试用例套件覆盖情况</a><br>
<a href="#58">    用例18 制定促销策略测试用例</a><br>
<a href="#59">      18.1 测试用例套件</a><br>
<a href="#60">      18.2 测试用例套件覆盖情况</a><br>
...
>>>>>>> 989b7ef0ef488494fdd2fc1a2e48d48dc0c33ccd
...
##用例4 库存盘点<a name="10"></a>

###4.1测试用例套件<a name="11"></a>
...
##用例5 处理库存单据<a name="13"></a>

###5.1测试用例套件<a name="14"></a>
...
###5.2 测试用例套件对需求的覆盖情况<a name="15"></a>
...
##用例 6 客户管理<a name="16"></a>

###6.1 测试用例套件<a name="17"></a>
...
##用例7 制定进货单<a name="19"></a>

###7.1 测试用例套件<a name="20"></a>
...
##用例7 制定进货退货单<a name="22"></a>

###7.1 测试用例套件<a name="23"></a>
...
##用例8 制定销售单<a name="25"></a>

###8.1 测试用例套件<a name="26"></a>
...
##用例7 制定销售退货单<a name="28"></a>

###7.1 测试用例套件<a name="29"></a>
...
##用例9 账户管理<a name="31"></a>

###9.1测试用例套件<a name="32"></a>
...
##用例10制定收款单及现金费用单<a name="34"></a>

###10.1 测试用例套件<a name="35"></a>
...
##用例11 制定付款单<a name="37"></a>

###11.1 测试用例套件<a name="38"></a>
...
##用例12 查看导出报表<a name="40"></a>

###12.1 测试用例套件<a name="41"></a>
...
##用例14 查看导出销售明细表测试用例<a name="46"></a>

### 14.1 测试用例套件<a name="47"></a>
...
## 用例15 查看导出经营情况表测试用例<a name="49"></a>

### 15.1 测试用例套件<a name="50"></a>
...
## 用例16 审批单据测试用例<a name="52"></a>

### 16.1 测试用例套件<a name="53"></a>
...
## 用例17 查询日志测试用例<a name="55"></a>

### 17.1 测试用例套件<a name="56"></a>
...
##用例18 制定促销策略测试用例<a name="58"></a>

###18.1 测试用例套件<a name="59"></a>
